  ...
  const contacts = [
    {
      ...
      firstName: 'Sarah',
      lastName: 'Johnson',
      profilePhotoUrl: '/profile-example-1.jpg',
    ...
    },
    {
      ...
      firstName: 'Michael',
      lastName: 'Chen',
      profilePhotoUrl: '/profile-example-2.jpg',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#3B00CC] to-[#5A17E0] text-white">
      ...
      <header className="p-4 flex items-center">
        <button className="mr-4 p-2 rounded-full bg-white/10 hover:bg-white/20 transition-colors">
