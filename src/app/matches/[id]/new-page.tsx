...
export default function MatchDetailPage() {
  ...
  const educationLevel = matchedUserData.questionnaireAnswers?.personal_educationLevel || 
                         matchedUserData.questionnaireAnswers?.education_level || 
                         matchedUserData.educationLevel || 'Not specified';
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-[#0F0C29] via-[#302B63] to-[#24243E] overflow-auto">
      {/* Background with orbs - fixed position */}
      ...
      <div className="relative z-10 container mx-auto px-4 py-4">
        ...
        {/* Card container */}
        <div className="max-w-4xl mx-auto rounded-2xl bg-white/10 backdrop-blur-lg shadow-[0_8px_32px_rgb(31,38,135,0.15)] p-6 md:p-8 mb-6">
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="w-full md:w-1/3 flex flex-col gap-6">
              ...
              {/* Name and Age Heading */}
              <h2 className={`${playfair.className} text-4xl md:text-5xl font-normal text-white mb-0`}>
                {matchedUserData.firstName} {matchedUserData.lastName}, {age}
              </h2>
              {/* Location below name - reduced margin and increased opacity */}
              <p className={`${playfair.className} text-white/75 text-xl mb-2 -mt-1`}>
                {displayLocation !== 'Location not specified' ? displayLocation : ''}
                {displayLocation !== 'Location not specified' && state ? ', ' : ''}
                {state}
              </p>
              
              {/* Basic Info Card - Single Glass Box */}
              <div className="bg-white/5 backdrop-blur-md rounded-xl p-4">
                <h3 className={`${inter.className} text-xl font-medium text-[#73FFF6] mb-2`}>
                  About
                </h3>
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-white text-base">{maritalStatus}</p>
                    </div>
                  </div>
                  ...
                  {height !== 'Not specified' && (
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="text-white text-base">{height}</p>
                      </div>
                    </div>
                  )}
                  ...
                  {profession !== 'Profession not specified' && (
                    <div className="flex items-center">
                      ...
                      <div className="flex items-center">
                        <p className="text-white text-base">{profession}</p>
                      </div>
                    </div>
                  )}
                  ...
                  {educationLevel !== 'Not specified' && (
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="text-white text-base">{educationLevel}</p>
                      </div>
                    </div>
                  )}
                </div>
              ...
              {/* Lifestyle */}
              <div className="bg-white/5 backdrop-blur-md rounded-xl p-4 mt-0">
                <h3 className={`${inter.className} text-xl font-medium text-[#73FFF6] mb-2`}>
                  Lifestyle
                </h3>
                <div className="grid grid-cols-2 gap-2">
            ...
            <div className="flex-1">
              ...
              {/* Compatibility Score */}
              <div className="bg-white/5 backdrop-blur-md rounded-xl p-4 mb-4 mt-4">
