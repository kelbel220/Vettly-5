...
export default function Profile() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="w-[85%] max-w-[1200px] mx-auto bg-transparent h-full overflow-hidden relative z-10">
        {/* Profile content - flex column for mobile, 3-column grid for desktop */}
        <div className="flex flex-col lg:grid lg:grid-cols-[1fr_4fr_4fr] lg:gap-8 h-full">
          {/* Vettly logo - visible on mobile only */}
          ...
          <div className="lg:pt-12">
            ...
            <div className="hidden lg:block mt-4 bg-white/15 backdrop-blur-md rounded-[20px] p-4">
          ...
          {/* Middle column for desktop - details section */}
          <div className="lg:mx-4 lg:pt-12">
          ...
          {/* Right column for desktop - interests and personal summary */}
          <div className="lg:mx-4 lg:pt-12">
