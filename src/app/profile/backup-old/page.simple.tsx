    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="w-[95%] mx-auto bg-transparent h-full overflow-hidden relative z-10">
        ...
        <div className="flex flex-col h-full">
          ...
          {/* Top section with image background that takes full width on mobile, smaller on desktop */}
          <div className="relative">
            ...
            {/* Profile image with improved cropping - smaller on desktop */}
            <div className="w-full aspect-[3/2.5] lg:w-1/3 lg:mx-auto relative overflow-hidden rounded-t-[40px] lg:rounded-[20px] lg:border-t-8 lg:border-green-600">
              <Image 
          ...
          <div className="relative -mt-10 bg-white/15 backdrop-blur-md rounded-[40px] flex-1 px-7 py-6">
            ...
            <div className="lg:grid lg:grid-cols-3 lg:gap-6">
              ...
              {/* Column 3: Interests and Personal Summary */}
              <div className="lg:col-span-1">
