  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="w-[95%] mx-auto bg-transparent h-full overflow-hidden relative z-10">
        ...
        {/* Profile content - mobile is vertical, desktop is 3-column grid */}
        <div className="flex flex-col lg:grid lg:grid-cols-12 lg:gap-6">
          ...
          <div className="lg:col-span-5">
            ...
            <div className="relative -mt-10 lg:mt-8 bg-white/15 backdrop-blur-md rounded-[40px] lg:rounded-[20px] px-7 py-6">
          ...
          {/* Right column - Interests and Personal Summary */}
