// Script to test the explanation generation API endpoint
// Run with: node src/scripts/test-explanation-api.js <matchId> <member1Id> <member2Id>

const fetch = require('node-fetch');

async function testExplanationAPI(matchId, member1Id, member2Id) {
  if (!matchId || !member1Id || !member2Id) {
    console.error('Usage: node test-explanation-api.js <matchId> <member1Id> <member2Id>');
    process.exit(1);
  }

  console.log(`Testing explanation generation for match ${matchId}...`);
...
testExplanationAPI(matchId, member1Id, member2Id);
